    ...
    <MantineProvider>
      ...
      <Grid overflow="hidden">
        <Grid.Col span="content"  >
          ...
          <Stack pl={20}>
            <ActionIcon onClick={open} variant="filled" size="xl" color='#800000' aria-label="Filter">
            ...
            <ScrollArea h={height-180}>
              <Group >
                <Group p={30}>
                  ...
                  <Stack>
                    <Stack>
                      <Text fw={700} size="xl">430 Cry Session</Text>
                    ...
                    <Group align="center">
                      <Button variant="filled" size="sm" color="#800000" radius="xl">Join</Button>
                      <Modalview/>
                    </Group>
                  </Stack>
                </Group>
